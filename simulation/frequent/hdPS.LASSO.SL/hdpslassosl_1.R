...
method.under.consider <- "hdpslassosl1"
...
if (! dir.exists(paste0(mainPath, paste0(method.under.consider,"SMD/") ))){
  dir.create(paste0(mainPath, paste0(method.under.consider,"SMD/") ), recursive = TRUE)
}
...
if (! dir.exists(paste0(mainPath, paste0(method.under.consider,"msg/") ))){
  dir.create(paste0(mainPath, paste0(method.under.consider,"msg/") ), recursive = TRUE)
}
...
clusterEvalQ(cl,{
  source(paste0("../../code/fextract1.R"), local = TRUE)
})
clusterEvalQ(cl,{
